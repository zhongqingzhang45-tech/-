...
import { createServer as createViteServer, mergeConfig as mergeViteConfig, build as viteBuild, } from 'vite';
...
export async function build(ctx) {
    ...
    const changeViteConfigCallbacks = [];
    ...
    const buildViteConfig = mergeViteConfig(buildViteConfigRaw, {
        mode: 'development',
        build: {
            lib: false,
            rollupOptions: {
