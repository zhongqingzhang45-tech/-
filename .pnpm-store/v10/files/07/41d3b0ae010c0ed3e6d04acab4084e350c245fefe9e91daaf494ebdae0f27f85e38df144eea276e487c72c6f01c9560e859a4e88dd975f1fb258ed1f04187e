...
var __webpack_modules__ = {
    ...
    "../extensions/error-tracking/modifiers/relative-path.node": function(module) {
        module.exports = require("../extensions/error-tracking/modifiers/relative-path.node.js");
    },
...
(()=>{
    ...
    var _extensions_error_tracking_modifiers_relative_path_node__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("../extensions/error-tracking/modifiers/relative-path.node");
    ...
    class PostHog extends _client__WEBPACK_IMPORTED_MODULE_4__.PostHogBackendClient {
        ...
        createErrorPropertiesBuilder() {
            return new _posthog_core__WEBPACK_IMPORTED_MODULE_5__.ErrorTracking.ErrorPropertiesBuilder([
