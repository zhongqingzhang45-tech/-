import { defineComponent, ref, watch, computed, createElementBlock, openBlock, createElementVNode, createBlock, createCommentVNode, createVNode, withCtx, unref, Fragment, renderList } from "@histoire/vendors/vue";
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        hasCustomControls.value ? (openBlock(), createBlock(_sfc_main$2, {
          ...
          default: withCtx(() => [
            ...
            _cache[1] || (_cache[1] = createElementVNode("span", null, "No controls available for this story", -1))
          ]),
          _: 1
        })) : createCommentVNode("", true),
        __props.variant.state?._hPropDefs?.length ? (openBlock(), createElementBlock("div", _hoisted_4, [
