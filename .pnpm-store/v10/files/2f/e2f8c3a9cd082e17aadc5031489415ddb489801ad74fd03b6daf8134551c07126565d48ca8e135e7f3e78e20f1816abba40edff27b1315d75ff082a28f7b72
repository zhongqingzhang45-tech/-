import type { BuildEndCallback, ChangeViteConfigCallback, HistoireConfig, ModuleLoader, Plugin, PluginApiBase, PluginApiBuild, PluginApiDev, PluginApiDevEvent, PreviewStoryCallback, ServerStory } from '@histoire/shared';
...
export declare class DevPluginApi extends BasePluginApi implements PluginApiDev {
    watcher: {
        ...
        FSWatcher: typeof import("chokidar").FSWatcher;
    };
}
