 ...
 */
function validateNewlinesAndPartitionConfig({
  partitionByNewLine,
  newlinesBetween,
  newlinesInside,
  customGroups,
...
function validateNewlinesBetweenConfig({ newlinesBetween, groups }) {
...
export { validateNewlinesAndPartitionConfig }
