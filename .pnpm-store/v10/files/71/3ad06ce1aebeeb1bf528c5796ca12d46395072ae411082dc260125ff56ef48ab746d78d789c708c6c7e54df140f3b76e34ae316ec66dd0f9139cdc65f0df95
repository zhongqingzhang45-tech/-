 ...
 */
export function writeHrTimeAsFixed64(serializer, hrTime) {
 ...
 */
export function writeAttributes(writer, attributes, fieldNumber) {
 ...
 */
export function writeKeyValue(writer, key, value) {
 ...
 */
export function writeAnyValue(writer, value) {
