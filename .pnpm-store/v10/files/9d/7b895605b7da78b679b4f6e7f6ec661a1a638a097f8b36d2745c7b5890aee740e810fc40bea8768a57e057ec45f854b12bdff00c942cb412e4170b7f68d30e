...
var ORDER_ERROR_ID = 'unexpectedIntersectionTypesOrder'
var GROUP_ORDER_ERROR_ID = 'unexpectedIntersectionTypesGroupOrder'
var EXTRA_SPACING_ERROR_ID = 'extraSpacingBetweenIntersectionTypes'
var MISSED_SPACING_ERROR_ID = 'missedSpacingBetweenIntersectionTypes'
var defaultOptions = {
...
var sort_intersection_types_default = createEslintRule({
  meta: {
    messages: {
