...
import { EmblaPluginType } from './Plugins.js';
import { EmblaSsrType } from './SsrHandler.js';
...
export declare function getSsrHandler(pluginList: EmblaPluginType[]): EmblaSsrType | undefined;
