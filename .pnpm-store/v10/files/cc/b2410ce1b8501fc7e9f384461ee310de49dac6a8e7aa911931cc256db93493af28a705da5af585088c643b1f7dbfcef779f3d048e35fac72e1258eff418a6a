import { defineComponent, computed, ref, watch, onMounted, createElementBlock, openBlock, createCommentVNode, createElementVNode, unref, createVNode, createBlock, normalizeStyle, Fragment, renderList } from "@histoire/vendors/vue";
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        !unref(isMobile) ? (openBlock(), createElementBlock("div", _hoisted_2, [
          ...
          _ctx.__HISTOIRE_DEV__ ? (openBlock(), createBlock(_sfc_main$2, {
            key: 0,
            file: unref(storyStore).currentStory.file?.filePath,
