import { r as __toESM, t as __commonJSMin } from "./chunk-f7LOQL_L.js";
import { A as renderList, B as withCtx, C as onMounted, Ct as normalizeClass, E as openBlock, Et as toDisplayString, F as useTemplateRef, L as watch, M as resolveComponent, N as resolveDynamicComponent, O as provide, P as useSlots, Q as ref, R as watchEffect, S as onBeforeUnmount, Tt as normalizeStyle, U as customRef, V as withDirectives, _ as h, at as unref, c as createBlock, f as createTextVNode, h as getCurrentInstance, it as toValue, j as renderSlot, l as createCommentVNode, m as defineComponent, o as computed, p as createVNode, rt as toRefs, s as createBaseVNode, t as Fragment, u as createElementBlock, x as nextTick, y as inject, z as withAsyncContext } from "./runtime-core.esm-bundler-DrsXb1EG.js";
import { c as vShow, i as useRouter, r as useRoute } from "./vue-router-a_c0AaOX.js";
import { _ as tryOnScopeDispose, a as isStaticMode, c as getHot, i as safeJsonParse, m as onKeyDown, n as guessMode, o as onModuleUpdated, r as inspectSourcemaps, s as rpc, t as usePayloadStore } from "./payload-DkARwyuW.js";
...
import { n as DurationDisplay_default, t as useOptionsStore } from "./options-BTLP_X4i.js";
import { n as ModuleId_default, r as kt, t as ModuleList_default } from "./ModuleList-BPriCktA.js";
//#region node_modules/.pnpm/splitpanes@4.0.4_vue@3.5.30_typescript@5.9.3_/node_modules/splitpanes/dist/splitpanes.es.js
var Pe = {
	__name: "splitpanes",
	props: {
		horizontal: {
...
async function calculateDiffWithWorker(left, right) {
	if (!diffWorker) diffWorker = wrap(new Worker(new URL(
		/* @vite-ignore */
		"" + new URL("diff.worker-D-A6qTXy.js", import.meta.url).href,
		"" + import.meta.url
	), { type: "module" }));
		...
		return (_ctx, _cache) => {
			return openBlock(), createBlock(unref(Pe), { onResize: _cache[0] || (_cache[0] = ($event) => onUpdate($event.prevPane.size)) }, {
				default: withCtx(() => [withDirectives(createVNode(unref(ge), {
					...
					_: 1
				}, 8, ["size"]), [[vShow, !__props.oneColumn]]), createVNode(unref(ge), {
					"min-size": "10",
...
//#endregion
//#region node_modules/.pnpm/@vueuse+router@14.2.1_vue-router@5.0.4_@vue+compiler-sfc@3.5.30_pinia@3.0.4_typescript@_e3fd73ca3b1330efbfd6734c9c8d80c7/node_modules/@vueuse/router/dist/index.js
...
var module_default = /* @__PURE__ */ defineComponent({
	...
	async setup(__props) {
		...
		const info = ref(id.value ? ([__temp, __restore] = withAsyncContext(() => rpc.call("vite-plugin-inspect:get-module-transform-info", payload.query, id.value)), __temp = await __temp, __restore(), __temp) : void 0);
		...
		async function refetch(clear = false) {
			if (!id.value) return;
			if (clear) await rpc.call("vite-plugin-inspect:clear-module-transform", payload.query, id.value);
