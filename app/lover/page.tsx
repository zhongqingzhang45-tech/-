...
const CHARACTERS: Character[] = [
  { id: "HaruGreeter", name: "春（迎宾）", path: "/live2d-models/HaruGreeter", model: "HaruGreeter", avatar: "🌸", scale: 1, positionY: 0.5, type: "cubism3", gender: "female" },
  { id: "lafei", name: "拉菲", path: "/live2d-models/azurlane/lafei", model: "lafei", avatar: "🍷", scale: 1, positionY: 0.5, type: "cubism3", gender: "female" },
  { id: "lafei_4", name: "拉菲（新春）", path: "/live2d-models/azurlane/lafei_4", model: "lafei_4", avatar: "🧧", scale: 1, positionY: 0.5, type: "cubism3", gender: "female" },
  { id: "lingbo", name: "绫波", path: "/live2d-models/azurlane/lingbo", model: "lingbo", avatar: "🌊", scale: 1, positionY: 0.5, type: "cubism3", gender: "female" },
  { id: "biaoqiang", name: "标枪", path: "/live2d-models/azurlane/biaoqiang", model: "biaoqiang", avatar: "🏹", scale: 1, positionY: 0.5, type: "cubism3", gender: "female" },
  { id: "biaoqiang_3", name: "标枪（泳装）", path: "/live2d-models/azurlane/biaoqiang_3", model: "biaoqiang_3", avatar: "🏖️", scale: 1, positionY: 0.5, type: "cubism3", gender: "female" },
  { id: "z23", name: "Z23", path: "/live2d-models/azurlane/z23", model: "z23", avatar: "⚓", scale: 1, positionY: 0.5, type: "cubism3", gender: "female" },
  { id: "z46_2", name: "Z46（夏装）", path: "/live2d-models/azurlane/z46_2", model: "z46_2", avatar: "☀️", scale: 1, positionY: 0.5, type: "cubism3", gender: "female" },
  { id: "aierdeliqi_5", name: "埃尔德里奇", path: "/live2d-models/azurlane/aierdeliqi_5", model: "aierdeliqi_5", avatar: "💫", scale: 1, positionY: 0.5, type: "cubism3", gender: "female" },
  { id: "xuefeng", name: "雪风", path: "/live2d-models/azurlane/xuefeng", model: "xuefeng", avatar: "❄️", scale: 1, positionY: 0.5, type: "cubism3", gender: "female" },
  { id: "dafeng_2", name: "大凤（盛宴）", path: "/live2d-models/azurlane/dafeng_2", model: "dafeng_2", avatar: "🦚", scale: 1, positionY: 0.5, type: "cubism3", gender: "female" },
  { id: "beierfasite_2", name: "贝尔法斯特", path: "/live2d-models/azurlane/beierfasite_2", model: "beierfasite_2", avatar: "🌹", scale: 1, positionY: 0.5, type: "cubism3", gender: "female" },
  { id: "dujiaoshou_4", name: "独角兽", path: "/live2d-models/azurlane/dujiaoshou_4", model: "dujiaoshou_4", avatar: "🦄", scale: 1, positionY: 0.5, type: "cubism3", gender: "female" },
  { id: "mingshi", name: "明石", path: "/live2d-models/azurlane/mingshi", model: "mingshi", avatar: "🐱", scale: 1, positionY: 0.5, type: "cubism3", gender: "female" },
  { id: "ninghai_4", name: "宁海（新春）", path: "/live2d-models/azurlane/ninghai_4", model: "ninghai_4", avatar: "🏮", scale: 1, positionY: 0.5, type: "cubism3", gender: "female" },
  { id: "pinghai_4", name: "平海（新春）", path: "/live2d-models/azurlane/pinghai_4", model: "pinghai_4", avatar: "🧧", scale: 1, positionY: 0.5, type: "cubism3", gender: "female" },
  { id: "bisimai_2", name: "俾斯麦", path: "/live2d-models/azurlane/bisimai_2", model: "bisimai_2", avatar: "⚔️", scale: 1, positionY: 0.5, type: "cubism3", gender: "female" },
  { id: "shengluyisi_3", name: "圣路易斯", path: "/live2d-models/azurlane/shengluyisi_3", model: "shengluyisi_3", avatar: "🍷", scale: 1, positionY: 0.5, type: "cubism3", gender: "female" },
  { id: "kelifulan_3", name: "克利夫兰", path: "/live2d-models/azurlane/kelifulan_3", model: "kelifulan_3", avatar: "🛡️", scale: 1, positionY: 0.5, type: "cubism3", gender: "female" },
  { id: "genaisennao_2", name: "格奈森瑙", path: "/live2d-models/azurlane/genaisennao_2", model: "genaisennao_2", avatar: "🗡️", scale: 1, positionY: 0.5, type: "cubism3", gender: "female" },
  { id: "aidang_2", name: "爱宕", path: "/live2d-models/azurlane/aidang_2", model: "aidang_2", avatar: "🌺", scale: 1, positionY: 0.5, type: "cubism3", gender: "female" },
  { id: "tianlangxing_3", name: "天狼星", path: "/live2d-models/azurlane/tianlangxing_3", model: "tianlangxing_3", avatar: "⭐", scale: 1, positionY: 0.5, type: "cubism3", gender: "female" },
  { id: "xianghe_2", name: "翔鹤", path: "/live2d-models/azurlane/xianghe_2", model: "xianghe_2", avatar: "🕊️", scale: 1, positionY: 0.5, type: "cubism3", gender: "female" },
];
