...
export default {
  ...
  mac: {
    ...
    extendInfo: [
      {
        NSMicrophoneUsageDescription: 'Life 需要麦克风权限以进行语音交互',
      },
      {
        NSCameraUsageDescription: 'Life 需要摄像头权限以进行视觉理解',
      },
    ],
    // For self-publishing, testing, and distribution after modified the code without access to
  ...
  linux: {
    ...
    category: 'Utility',
    synopsis: 'Life - 面向国内用户的二次元 AI 虚拟伴侣',
    description: 'Life 是一款面向国内用户的沉浸式二次元 AI 虚拟伴侣，支持 Live2D/VRM 角色、智能聊天与语音互动。',
    executableName: 'life',
