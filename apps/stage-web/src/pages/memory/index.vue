...
<template>
  <div class="h-full w-full overflow-y-auto scrollbar-none">
    <div class="mx-auto max-w-4xl px-6 py-10">
      ...
      <!-- Tabs -->
      <div class="mb-8 flex gap-1 rounded-2xl bg-neutral-100/80 p-1 dark:bg-neutral-800/60 w-fit">
        <button
          :class="[
      ...
      <!-- Short Term -->
      <div v-if="tabs === 'short-term'" class="flex flex-col gap-8">
        <!-- Stats -->
      ...
      <div v-else class="flex flex-col gap-8">
        ...
        <div class="grid grid-cols-2 gap-4 md:grid-cols-4">
          <div
            ...
            :key="cat.id"
            :class="[
              'group rounded-2xl p-6 transition-all duration-200 cursor-pointer',
              'bg-white/80 backdrop-blur-sm dark:bg-neutral-900/60',
              'border border-neutral-200/60 dark:border-neutral-800/60',
          ...
          >
            <div
              :class="[
                'mb-4 flex h-14 w-14 items-center justify-center rounded-xl bg-gradient-to-br text-white',
                cat.color,
              ]"
            >
        ...
        <!-- Timeline Preview -->
        <div>
          <h3 class="mb-5 text-lg font-semibold text-neutral-800 dark:text-neutral-200">
            记忆时间线
          </h3>
          <div class="relative">
